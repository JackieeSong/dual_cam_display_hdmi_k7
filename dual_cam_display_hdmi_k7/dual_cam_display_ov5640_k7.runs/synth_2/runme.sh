...
HD_PWD='E:/education/no12/week12/dual_cam_display_ov5640_k7/dual_cam_display_ov5640_k7.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log dual_cam_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dual_cam_display.tcl
