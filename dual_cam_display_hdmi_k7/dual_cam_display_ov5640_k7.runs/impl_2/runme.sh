...
HD_PWD='E:/education/no12/week12/dual_cam_display_ov5640_k7/dual_cam_display_ov5640_k7.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log dual_cam_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dual_cam_display.tcl -notrace
