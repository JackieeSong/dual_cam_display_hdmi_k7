...
HD_PWD='E:/education/no12/week12/dual_cam_display_ov5640_k7/dual_cam_display_ov5640_k7.runs/clk_200M_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_200M.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_200M.tcl
