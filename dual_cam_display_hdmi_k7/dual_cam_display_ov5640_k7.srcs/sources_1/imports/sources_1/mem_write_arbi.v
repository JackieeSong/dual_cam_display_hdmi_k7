...
begin
	case(write_state)
		...
		//
		CH0_CHECK:
			if(ch0_wr_burst_req  && ch0_wr_burst_len != {BUSRT_BITS{1'd0}})	//拼位，10个1'd0
		...
		CH0_WRITE:
			if(wr_burst_finish_d1) //wr_burst_finish_d1 AXI_MASTER送过来的
...
begin
	if(~rst_n)
		begin
			wr_burst_len <= {BUSRT_BITS{1'd0}};//BUSRT_BITS代表10=等价10'd0
